...
def determine_contrasts(subject_id):
    from glob import glob
    import os
    first_lvl_dir = '/home/data/madlab/data/mri/seqtrd/frstlvl/seqbl_1st_corrincorr_July2018'
    #wanted_contrasts = ['inseq_corr', 'inseq_incorr', 'repeat_corr', 'repeat_incorr',
    #                    'skip_corr', 'skip_incorr', 'ot_corr', 'ot_incorr',
    #                    'InseqCorr_minus_InseqIncorr', 'InseqIncorr_minus_InseqCorr',
    #                    'RepeatCorr_minus_RepeatIncorr', 'RepeatIncorr_minus_RepeatCorr',
    #                    'SkipCorr_minus_SkipIncorr', 'SkipIncorr_minus_SkipCorr',
    #                    'InseqCorr_minus_OutseqCorr', 'OutseqCorr_minus_InseqCorr',
    #                    'InseqIncorr_minus_OutseqIncorr', 'OutseqIncorr_minus_InseqIncorr',
    #                    'InseqCorr_minus_RepeatCorr', 'RepeatCorr_minu_InseqCorr',
    #                    'InseqCorr_minus_RepeatIncorr', 'RepeatIncorr_minus_InseqCorr',
    #                    'InseqCorr_minus_SkipCorr', 'SkipCorr_minu_InseqCorr',
    #                    'InseqCorr_minus_SkipIncorr', 'SkipIncorr_minus_InseqCorr',
    #                    'OTCorr_minus_OTIncorr', 'OTIncorr_minus_OTCorr',
    #                    'OTCorr_minu_InseqCorr', 'InseqCorr_minus_OTCorr',
    #                    'InseqCorr_minus_OTIncorr', 'OTIncorr_minus_InseqCorr'] 
    wanted_contrasts = ['SkipCorr_minus_SkipIncorr', 'skipIncorr_minus_SkipCorr']
    avail_contrasts = []
    rel_runnums = []
...
def secondlevel_wf(subject_id,
    ...
    datasource.inputs.field_template = dict(copes='frstlvl/seqbl_1st_corrincorr_July2018/%s/modelfit/contrasts/_estimate_model*/cope*_%s.nii.gz',
                                            varcopes='frstlvl/seqbl_1st_corrincorr_July2018/%s/modelfit/contrasts/_estimate_model*/varcope*_%s.nii.gz',
                                            mask_file='preproc/%s/seq/ref/_fs_threshold20/%s*_thresh.nii',
                                            dof_files='frstlvl/seqbl_1st_corrincorr_July2018/%s/modelfit/dofs/_estimate_model*/%s')
    ...
    scndlvl_wf.connect(scndlvl_outputspec, 'copes', sinkd, 'seq_1stpos_cic_bl.fixedfx.@copes')
    scndlvl_wf.connect(scndlvl_outputspec, 'varcopes', sinkd, 'seq_1stpos_cic_bl.fixedfx.@varcopes')
    scndlvl_wf.connect(scndlvl_outputspec, 'tstats', sinkd, 'seq_1stpos_cic_bl.fixedfx.@tstats')
    scndlvl_wf.connect(scndlvl_outputspec, 'zstats', sinkd, 'seq_1stpos_cic_bl.fixedfx.@zstats')
    scndlvl_wf.connect(scndlvl_outputspec, 'res4d', sinkd, 'seq_1stpos_cic_bl.fixedfx.@pvals')
